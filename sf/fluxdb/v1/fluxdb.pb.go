...
func file_sf_fluxdb_v1_fluxdb_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sf_fluxdb_v1_fluxdb_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_sf_fluxdb_v1_fluxdb_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_sf_fluxdb_v1_fluxdb_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_sf_fluxdb_v1_fluxdb_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_sf_fluxdb_v1_fluxdb_proto_msgTypes[4].Exporter = func(v any, i int) any {
