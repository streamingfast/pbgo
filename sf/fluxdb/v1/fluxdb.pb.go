...
const file_sf_fluxdb_v1_fluxdb_proto_rawDesc = "" +
	"\n" +
	"\x19sf/fluxdb/v1/fluxdb.proto\x12\fsf.fluxdb.v1\x1a\x1bsf/bstream/v1/bstream.proto\"p\n" +
	"\vTabletIndex\x12'\n" +
	"\x0fsquelched_count\x18\x01 \x01(\x04R\x0esquelchedCount\x128\n" +
	"\aentries\x18\x02 \x03(\v2\x1e.sf.fluxdb.v1.TabletIndexEntryR\aentries\"K\n" +
	"\x10TabletIndexEntry\x12\x1f\n" +
	"\vprimary_key\x18\x01 \x01(\fR\n" +
	"primaryKey\x12\x16\n" +
	"\x06height\x18\x02 \x01(\x04R\x06height\"S\n" +
	"\n" +
	"Checkpoint\x12\x16\n" +
	"\x06height\x18\x01 \x01(\x04R\x06height\x12-\n" +
	"\x05block\x18\x02 \x01(\v2\x17.sf.bstream.v1.BlockRefR\x05block\"\xd3\x01\n" +
	"\fWriteRequest\x12A\n" +
	"\x0fsinglet_entries\x18\x01 \x03(\v2\x18.sf.fluxdb.v1.WriteEntryR\x0esingletEntries\x129\n" +
	"\vtablet_rows\x18\x02 \x03(\v2\x18.sf.fluxdb.v1.WriteEntryR\n" +
	"tabletRows\x12\x16\n" +
	"\x06height\x18\x03 \x01(\x04R\x06height\x12-\n" +
	"\x05block\x18\x04 \x01(\v2\x17.sf.bstream.v1.BlockRefR\x05block\"4\n" +
	"\n" +
	"WriteEntry\x12\x10\n" +
	"\x03key\x18\x02 \x01(\fR\x03key\x12\x14\n" +
	"\x05value\x18\x03 \x01(\fR\x05valueB5Z3github.com/streamingfast/pbgo/sf/fluxdb/v1;pbfluxdbb\x06proto3"

var (
	file_sf_fluxdb_v1_fluxdb_proto_rawDescOnce sync.Once
	file_sf_fluxdb_v1_fluxdb_proto_rawDescData []byte
)

func file_sf_fluxdb_v1_fluxdb_proto_rawDescGZIP() []byte {
	file_sf_fluxdb_v1_fluxdb_proto_rawDescOnce.Do(func() {
		file_sf_fluxdb_v1_fluxdb_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sf_fluxdb_v1_fluxdb_proto_rawDesc), len(file_sf_fluxdb_v1_fluxdb_proto_rawDesc)))
	})
...
var file_sf_fluxdb_v1_fluxdb_proto_goTypes = []any{
...
func file_sf_fluxdb_v1_fluxdb_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sf_fluxdb_v1_fluxdb_proto_rawDesc), len(file_sf_fluxdb_v1_fluxdb_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
