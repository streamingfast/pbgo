...
func file_sf_firehose_v1_firehose_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sf_firehose_v1_firehose_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_sf_firehose_v1_firehose_proto_msgTypes[1].Exporter = func(v any, i int) any {
