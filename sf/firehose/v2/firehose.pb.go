...
const (
	...
	// Partial block
	// An example of a partial block is a "Flash Block" as seen on the BASE blockchain.
	// Blocks with STEP_PARTIAL are do not receive an "UNDO" signal when they are replaced
	// by another partial block or by the full block.
	// You will ALWAYS receive a "NEW" signal with a full block when a full block replaces a partial block
	// You should never receive an "old" STEP_PARTIAL
	ForkStep_STEP_PARTIAL ForkStep = 4
)
...
type Request struct {
	...
	// With include_partial_blocks, you will also receive blocks with STEP_PARTIAL
	// An example of a partial block is a "Flash Block" as seen on the BASE blockchain.
	// Blocks with STEP_PARTIAL are do not receive an "UNDO" signal when they are replaced
	// by another partial block or by the full block.
	// You will ALWAYS receive a "NEW" signal with a full block when a full block replaces a partial block
	// You should never receive an "old" STEP_PARTIAL
	IncludePartialBlocks bool         `protobuf:"varint,5,opt,name=include_partial_blocks,json=includePartialBlocks,proto3" json:"include_partial_blocks,omitempty"`
...
const file_sf_firehose_v2_firehose_proto_rawDesc = "" +
	...
	"\bmetadata\x18\x02 \x01(\v2\x1d.sf.firehose.v2.BlockMetadataR\bmetadata\"\x87\x02\n" +
	"\aRequest\x12&\n" +
	...
	"\x16include_partial_blocks\x18\x05 \x01(\bR\x14includePartialBlocks\x124\n" +
	"\n" +
	"transforms\x18\n" +
	...
	"\x1bBLOCK_ID_ENCODING_BASE64URL\x10\x05*Y\n" +
	"\bForkStep\x12\x0e\n" +
	"\n" +
	...
	"\n" +
	"STEP_FINAL\x10\x03\x12\x10\n" +
	"\fSTEP_PARTIAL\x10\x042G\n" +
	"\x06Stream\x12=\n" +
