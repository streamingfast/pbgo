...
func RegisterTimeToIDServer(s grpc.ServiceRegistrar, srv TimeToIDServer) {
	// If the following call pancis, it indicates UnimplementedTimeToIDServer was
...
func RegisterBlockIDServer(s grpc.ServiceRegistrar, srv BlockIDServer) {
	// If the following call pancis, it indicates UnimplementedBlockIDServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterForksServer(s grpc.ServiceRegistrar, srv ForksServer) {
	// If the following call pancis, it indicates UnimplementedForksServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func RegisterChainDiscriminatorServer(s grpc.ServiceRegistrar, srv ChainDiscriminatorServer) {
	// If the following call pancis, it indicates UnimplementedChainDiscriminatorServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
