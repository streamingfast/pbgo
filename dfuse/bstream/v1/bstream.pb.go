...
type BlocksRequestV2 struct {
	...
	FilteringIncludeFilterExpr string `protobuf:"bytes,10,opt,name=filtering_include_filter_expr,json=filteringIncludeFilterExpr,proto3" json:"filtering_include_filter_expr,omitempty"`
	...
	FilteringExcludeFilterExpr string   `protobuf:"bytes,11,opt,name=filtering_exclude_filter_expr,json=filteringExcludeFilterExpr,proto3" json:"filtering_exclude_filter_expr,omitempty"`
	XXX_NoUnkeyedLiteral       struct{} `json:"-"`
	XXX_unrecognized           []byte   `json:"-"`
	XXX_sizecache              int32    `json:"-"`
}
...
func (m *BlocksRequestV2) GetFilteringIncludeFilterExpr() string {
	if m != nil {
...
func (m *BlocksRequestV2) GetFilteringExcludeFilterExpr() string {
	if m != nil {
...
var fileDescriptor_9cfb17be2e7d1b7d = []byte{
	...
	,
}
